...
When running this workflow as a guided conversation, follow this interaction protocol:
...
- Label progress on each question (for example, `Context Qx/8` and `Scoring Qx/5`).
